  ...
  return (
    ...
    >
      <div style={styles.modalContent}>
        <h3 id="modal-title">Multiple Active Sessions Detected </h3>
        <p>
        It looks like you have more than one active session. 
        Clicking "Continue" will log you out from other devices or browsers. 
        </p>
        <button style={styles.loginButton} onClick={onLogin}>Continue</button>
